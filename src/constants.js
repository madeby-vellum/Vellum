...
// Predefined journal cover options used in UI selection
export const PRESET_COVERS = [
  {
    id: "book-cover",
    label: "Book Journal",
    style: {
      backgroundImage: "url(/covers/book-journal.jpeg)",
  ...
  },
  {
    ...
    style: {
      backgroundImage: "url(/covers/cooking-journal.jpeg)",
      backgroundSize: "cover",
      backgroundPosition: "center"
    }
  },
  {
    ...
    label: "Movie Journal",
    style: {
      backgroundImage: "url(/covers/movie-journal.jpeg)",
      backgroundSize: "cover",
      backgroundPosition: "center"
    }
  },
  {
    ...
    label: "To-Do Journal",
    style: {
      backgroundImage: "url(/covers/todo-journal.jpeg)",
      backgroundSize: "cover",
      backgroundPosition: "center"
    }
  },
  {
    ...
    style: {
      backgroundImage: "url(/covers/marble.jpeg)",
      backgroundSize: "cover",
      backgroundPosition: "center"
    }
  },
  {
    id: "paint-cover",
    label: "Paint Splotches",
    style: {
      backgroundImage: "url(/covers/paint.jpeg)",
      backgroundSize: "cover",
      backgroundPosition: "center"
    }
  },
...
// Template definitions used for spreads (free + pro tiers)
export const TEMPLATES = [
  ...
  // Planner templates (pro-only category)
  ...
  // Habit / challenge tracking templates
...
// Categories used for grouping pro templates in UI
...
// Returns correct CSS background style for a journal cover
export function getCoverStyle(j) {

  // If using preset cover selection
  if (j.coverType === "preset") {
    const preset = PRESET_COVERS.find(c => c.id === j.coverId);
    return preset?.style || {};
  }

  // If using uploaded or Unsplash image
...
// Template packs metadata for free/pro template categories
...
/* Sticker image library used in editor UI */
