    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card modal-card--small" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-header">
          ...
          <div className="modal-copy redeem-unlocked-label">You've unlocked the</div>
          <div className="modal-feature-title redeem-unlocked-pack">{unlockedCategory} Pack</div>
          <div className="modal-copy redeem-unlocked-copy">
            Each new account gets one free pack. Upgrade to Pro to unlock all template categories.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card modal-card--small" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          ...
          <div className="modal-feature-title redeem-confirm-pack">{selected} Pack</div>
        </div>
        <div className="modal-footer modal-action-row">
          <button onClick={() => setConfirming(false)} className="modal-button--secondary">go back</button>
          <button onClick={() => onRedeem(selected)}   className="modal-button--danger">redeem this pack</button>
        </div>
      </div>
    </div>
  );
        ...
        <div className="modal-body">
          ...
          <div className="modal-action-row">
            <button
              ...
              className={`modal-button ${selected ? "modal-button--primary" : "modal-button--disabled"}`}
              disabled={!selected}
            >
